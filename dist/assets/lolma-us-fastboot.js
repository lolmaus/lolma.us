define('lolma-us/initializers/ajax', ['exports'], function (exports) {
  'use strict';
...
define('lolma-us/initializers/error-handler', ['exports'], function (exports) {
  'use strict';
...
define('lolma-us/instance-initializers/ember-data-fastboot', ['exports'], function (exports) {
  'use strict';
  ...
  function initialize(appInst) {
    var store = appInst.lookup('service:store');
    var shoebox = appInst.lookup('service:fastboot').get('shoebox');
    var modelNames = appInst.lookup('data-adapter:main').getModelTypes().mapBy('name');

    shoebox.put('ember-data-store', {
      get types() {
        return modelNames.reduce(function (hash, modelName) {
          // const modelNamePlural = pluralize(modelName)

          try {
            hash[modelName] = store.peekAll(modelName).toArray().map(function (record) {
...
//# sourceMappingURL=lolma-us-fastboot.map
