...
define('@ember/test-helpers/setup-rendering-context', ['exports', '@ember/test-helpers/global', '@ember/test-helpers/setup-context'], function (exports, _global, _setupContext) {
  ...
  exports.default = function (context) {
    var guid = Ember.guidFor(context);
    ...
    return new Ember.RSVP.Promise(function (resolve) {
      ...
      Ember.run.next(function () {
        ...
        context.render = function render(template) {
          ...
          return new Ember.RSVP.Promise(function asyncRender(resolve) {
            ...
            Ember.run.next(function asyncRenderSetup() {
              ...
              Ember.run.next(function asyncUpdateElementAfterRender() {
        ...
        context.clearRender = function clearRender() {
          return new Ember.RSVP.Promise(function async_clearRender(resolve) {
            element = undefined;

            Ember.run.next(function async_clearRender() {
